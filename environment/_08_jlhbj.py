...
# 吉林省环境保护厅
# http://hbj.jl.gov.cn/ztzl/sgszl/xzcfxx/
url_format = 'http://hbj.jl.gov.cn/ztzl/sgszl/xzcfxx/index{}.html'
gov_name = '吉林省环境保护厅'
...
def crawler():
    ...
    page_count_text = soup.body.find(class_='pageszly')
    ...
    for num in range(page_count):
        ...
        try:
            ...
            soup = bs(response.content if response else '', 'lxml')
            for x in soup.body.find(class_='main-list-rainbow').find_all('li'):
                anc_url = x.label.a.attrs['href'].strip()
