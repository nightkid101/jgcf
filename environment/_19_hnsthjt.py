...
# 湖南省环境保护厅
# http://sthjt.hunan.gov.cn/xxgk/zdly/jdzf/ajcc/
url_format = 'http://sthjt.hunan.gov.cn/xxgk/zdly/jdzf/ajcc/index{}.html'
gov_name = '湖南省环境保护厅'
...
def crawler():
    ...
    page_count_text = soup.body.find(class_='nextpage')
    ...
    for num in range(page_count):
        ...
        try:
            ...
            soup = bs(response.content if response else '', 'lxml')
            for x in soup.find(class_='table_list').tbody.find_all('tr'):
