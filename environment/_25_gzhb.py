...
# 贵州省环境保护厅
# http://hb.guizhou.gov.cn/hjjc_70741/hjzf_70743/gpdb/index.html
# http://hb.guizhou.gov.cn/hjjc_70741/xzcf_70748/index.html
url_format_list = [
    'http://hb.guizhou.gov.cn/hjjc_70741/hjzf_70743/gpdb/index{}.html',
    'http://hb.guizhou.gov.cn/hjjc_70741/xzcf_70748/index{}.html',
]
...
def crawler(url_format):
    ...
    for num in range(page_count):
        ...
        try:
            ...
            soup = bs(response.content if response else '', 'lxml')
            for x in soup.body.find(class_='list').find_all('li'):
