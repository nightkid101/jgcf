import re
#http://sthjt.hubei.gov.cn:8080/pub/root8/auto588/201801/t20180111_110912.html
...
# 四川省环境保护厅
# http://sthjt.sc.gov.cn/hjgl/hjjc/hjwfpgt/xzcf_8816/index.html
# http://sthjt.sc.gov.cn/hjgl/hjjc/hjwfpgt/cbqyclqk/index.html
url_format_list = [
    'http://sthjt.sc.gov.cn/hjgl/hjjc/hjwfpgt/xzcf_8816/index{}.html',
    'http://sthjt.sc.gov.cn/hjgl/hjjc/hjwfpgt/cbqyclqk/index{}.html',
]
...
def crawler(url_format):
    ...
    page_count_text = soup.body.find(class_='p_next')
    ...
    for num in range(page_count):
        ...
        try:
            ...
            soup = bs(response.content if response else '', 'lxml')
            for x in soup.body.find('dl').find_all('dd'):
